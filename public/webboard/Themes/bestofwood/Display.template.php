...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		if (!empty($message['member']['title']))
			echo '
								<li class="postprofilsredina sjena">', $message['member']['title'], '</li>';

		// Show the member's primary group (like 'Administrator') if they have one.
		if (!empty($message['member']['group']))
			echo '
								<li class="postprofilsredina sjena">', $message['member']['group'], '</li>';
		...
		if (!$message['member']['is_guest'])
		{
			...
			if ((empty($settings['hide_post_group']) || $message['member']['group'] == '') && $message['member']['post_group'] != '')
				echo '
								<li class="postprofilsredina sjena">', $message['member']['post_group'], '</li>';
			echo '
								<li class="postprofilsredina sjena">', $message['member']['group_stars'], '</li>';

			// Show avatars, images, etc.?
			if (!empty($settings['show_user_images']) && empty($options['show_no_avatars']) && !empty($message['member']['avatar']['image']))
				echo '
								<li class="postprofilsredina sjena">
			...
			if (!isset($context['disabled_fields']['posts']))
				echo '
								<li class="postprofilsredina sjena">', $txt['member_postcount'], ': ', $message['member']['posts'], '</li>';

			// Is karma display enabled?  Total or +/-?
			if ($modSettings['karmaMode'] == '1')
				echo '
								<li class="postprofilsredina sjena">', $modSettings['karmaLabel'], ' ', $message['member']['karma']['good'] - $message['member']['karma']['bad'], '</li>';
			...
			if (!empty($settings['show_gender']) && $message['member']['gender']['image'] != '' && !isset($context['disabled_fields']['gender']))
				echo '
								<li class="postprofilsredina sjena">', $txt['gender'], ': ', $message['member']['gender']['image'], '</li>';

			// Show their personal text?
			if (!empty($settings['show_blurb']) && $message['member']['blurb'] != '')
				echo '
								<li class="postprofilsredina sjena"><div class="postprofilcustom">', $message['member']['blurb'], '</div></li>';
			...
			if (!empty($message['member']['custom_fields']))
			{
				...
				foreach ($message['member']['custom_fields'] as $custom)
				{
					...
					echo '
										<li><div class="postprofilcustom">', $custom['value'], '</div></li>';
				}
				if ($shown)
					echo '
									</ul>
		...
		echo '
                      ...
                      if ($message['id'] == $context['topic_first_message'] && (!empty($settings['enable_facebook_share_button']))) { 
                            echo '<br /><br /><a name="fb_share" type="box_count" href="http://www.facebook.com/sharer.php">', $txt['bw_share_facebook'], '</a><script src="http://static.ak.fbcdn.net/connect.php/js/FB.Share" type="text/javascript"></script><br /><br />';
                            };							
...
<a href="http://twitter.com/share" class="twitter-share-button" data-count="vertical">', $txt['bw_tweet'], '</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script></span>';
};
