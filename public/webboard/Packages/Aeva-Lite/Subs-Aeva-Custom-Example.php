...
This is the file where you can include additional websites and settings that are not provided in the Aeva package.
Its name is "Subs-Aeva-Custom-Example.php", you just need to rename it to "Subs-Aeva-Custom.php" and fill it with
your custom site definitions. They will never be deleted when upgrading Aeva.

Upload the file to your Sources folder, go to the Admin area, check out the Aeva section, enable the custom sites
at the bottom and save your choices. You can now start embedding them in your posts.
...
------------------------------------------
	...
	All [regex] patterns are only partial. So don't specify delimiters, etc. The regex is completed when it's used.
