<?php
class Application_Form_SignUpTeam extends Zend_Form
{
	...
	public function init() 
	{
        ...
        $confirmPassword = $this->createElement('password','confirmPassword')
	                			...
	                			->setRequired(true)
	                			->addFilter('StringTrim')
	                			->addErrorMessage($translator->translate('TOURNAMENT_VALIDATE_PLEASE_INPUT').' Confirm Password')
	                			->setAttrib('style', $this->DEFAULT_TEXT_STYLE);
...
/*
        ...
        $captcha = $this->createElement('Captcha', 'ReCaptcha',
                		...
                		->addErrorMessage($translator->translate('TOURNAMENT_VALIDATE_PLEASE_INPUT').' '.$translator->translate('TOURNAMENT_VALIDATE_CORRECT_CAPTHA'));
*/
